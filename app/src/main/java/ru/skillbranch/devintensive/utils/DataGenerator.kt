...
import ru.skillbranch.devintensive.models.data.User as User1
...
object DataGenerator {
    ...
    private fun generateUsers(count: Int): List<User1> {
        val list = mutableListOf<User1>()
    ...
    private fun generateRandomMessages(chat: Chat, users: List<User1>): MutableList<BaseMessage> {
    ...
    private fun randomUser(users: List<User1>): User1 {
